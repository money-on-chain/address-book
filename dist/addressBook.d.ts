...
import type { Environment, ProxyMetadata } from "./types.js";
...
export declare const addresses: {
    readonly mainnet: {
        readonly moc: {
            ...
            readonly oracleManager: `0x${string}`;
            readonly mocRegistry: `0x${string}`;
            readonly mocToken: `0x${string}`;
            readonly docToken: `0x${string}`;
            readonly mocStateV1: `0x${string}`;
            readonly supporters: `0x${string}`;
            readonly foundation: `0x${string}`;
            readonly tasksRunner: `0x${string}`;
            readonly docToRbtcPriceProvider: `0x${string}`;
            readonly rbtcToMocMocRewardsReverseAuction: `0x${string}`;
            readonly mocV1: `0x${string}`;
            readonly mocInrateV1: `0x${string}`;
            readonly coiner: `0x${string}`;
            readonly multicall2: `0x${string}`;
            readonly vendor: `0x${string}`;
            readonly rns: `0x${string}`;
        };
        readonly roc: {
            readonly governor: `0x${string}`;
            readonly governorOwner: `0x${string}`;
            readonly oracleManager: `0x${string}`;
            readonly mocRegistry: `0x${string}`;
            readonly mocMultiCollateralGuard: `0x${string}`;
            readonly mocCore: `0x${string}`;
            readonly mocToken: `0x${string}`;
            readonly rifToken: `0x${string}`;
            readonly rifProToken: `0x${string}`;
            readonly usdRifToken: `0x${string}`;
            readonly docToken: `0x${string}`;
            readonly docProToken: `0x${string}`;
            readonly rifBucket: `0x${string}`;
            readonly docBucket: `0x${string}`;
            readonly rifQueue: `0x${string}`;
            readonly docQueue: `0x${string}`;
            readonly rifUsdLegacyPriceProvider: `0x${string}`;
            readonly rifToRbtcPriceProvider: `0x${string}`;
            readonly docToUsdRifPriceProvider: `0x${string}`;
            readonly docToRbtcPriceProvider: `0x${string}`;
            readonly mocToRifBasePriceProvider: `0x${string}`;
            readonly rifToRbtcDivisorPriceProvider: `0x${string}`;
            readonly btcUsdCoinPair: `0x${string}`;
            readonly supporters: `0x${string}`;
            readonly foundation: `0x${string}`;
            readonly holder: `0x${string}`;
            readonly oracleOwner1: `0x${string}`;
            readonly oracleOwner2: `0x${string}`;
            readonly oracleOwner3: `0x${string}`;
            readonly rifCommissionSplitterV2: `0x${string}`;
            readonly rifCommissionSplitterV3: `0x${string}`;
            readonly docCommissionSplitterV2: `0x${string}`;
            readonly mocCommissionSplitterV2: `0x${string}`;
            readonly mocCommissionSplitterV3: `0x${string}`;
            readonly rifProRewardsBuffer: `0x${string}`;
            readonly rocrRewardsBuffer: `0x${string}`;
            readonly bitProRewardsBuffer: `0x${string}`;
            readonly bproRewardsBuffer: `0x${string}`;
            readonly mocRewardsBuffer: `0x${string}`;
            readonly rifToMocRocRewardsReverseAuction: `0x${string}`;
            readonly mocToRifRifBucketReverseAuction: `0x${string}`;
            readonly docToMocRocRewardsReverseAuction: `0x${string}`;
            readonly mocToDocDocBucketReverseAuction: `0x${string}`;
            readonly rbtcToMocMocRewardsReverseAuction: `0x${string}`;
            readonly mocToRbtcMocV1ReverseAuction: `0x${string}`;
            readonly mocStateV1: `0x${string}`;
            readonly tasksRunner: `0x${string}`;
            readonly rifUsdCoinPair: `0x${string}`;
            readonly rbtcToMocPriceProvider: `0x${string}`;
            readonly rifToMocPriceProvider: `0x${string}`;
            readonly multicall2: `0x${string}`;
            readonly onlyMainnetRdocToken: `0x${string}`;
            readonly onlyMainnetTokenMigrator: `0x${string}`;
        };
        readonly governance: {
            readonly votingMachine: `0x${string}`;
            readonly votingUpgradeDelegator: `0x${string}`;
            readonly coiner: `0x${string}`;
        };
    };
    readonly testnet: {
        ...
        readonly roc: {
            ...
            readonly rifToken: `0x${string}`;
            readonly rifProToken: `0x${string}`;
            readonly onlyTestnetLegacyRifProToken: `0x${string}`;
            readonly onlyTestnetRifProMigrator: `0x${string}`;
            readonly usdRifToken: `0x${string}`;
            readonly docToken: `0x${string}`;
            readonly docProToken: `0x${string}`;
            readonly rifBucket: `0x${string}`;
...
export declare function findAddress<E extends Environment>(environment: E, name: AddressName<E>): Address;
export {};
